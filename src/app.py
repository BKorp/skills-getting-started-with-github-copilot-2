...
activities.update({
    "Basketball Team": {
        "description": "Competitive basketball team for inter-school games",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "sam@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Lap swimming and stroke improvement sessions",
    ...
    "Debate Team": {
        "description": "Competitive debate team focusing on public speaking and argumentation",
